...
const itemJobHtml = (candidateJob) => (
  ` <div style="padding-top:7px;">
    <tr>
      <div>
        <td
        style="padding: 20px;border-bottom: 0.5px solid hsl(0, 0%, 90%);box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;margin-top:7px;"
        valign="top">
        <a style="text-decoration: none;"
          href="http://139.162.51.41:4000/careers/hn-hn-team/6180b26e-a609-44a9-8495-7f15dfbd1b73">
              ...
              <tr>
                <td valign="middle">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tbody>
                      <tr>
                        <td style="display: flex;align-items: center;" class="pc-fb-font"
                          style="line-height: 24px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 500; letter-spacing: -0.1px; color: #1B1B1B;"
                          valign="top">
                          <a style="text-decoration: none; color: #1B1B1B;">${candidateJob.Candidate.name}</a>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td class="pc-fb-font"
                          style="line-height: 20px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; letter-spacing: -0.2px; color: #9B9B9B;"
                          valign="top">
                          <b>${candidateJob.Job.title}(${candidateJob.Job.salary})</b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
      ...
      <td
        ...
        valign="top">
        <div style="
        background-color: ${candidateJob.Lane ? candidateJob.Lane.background : ''};
        color: #fff;
        text-align: center;
        padding-top: 15px;
        padding-bottom: 15px;
        font-weight: 700;
        cursor: pointer;">${candidateJob.Lane ? candidateJob.Lane.nameColumn : ''}</div>
      </td>
      </div>
    </tr>
  </div>
...
const templateCandidate = (candidateJobs) => {
  let itemCanjob = '';
  // eslint-disable-next-line no-restricted-syntax
  for (const canJob of candidateJobs) {
    itemCanjob += itemJobHtml(canJob);
  }
  return (
    `<!DOCTYPE html
